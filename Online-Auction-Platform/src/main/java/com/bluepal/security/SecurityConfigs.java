...
//            .authorizeHttpRequests(auth -> auth
//                .requestMatchers(
//                    "/auth/**",          // Public auth APIs
//                    "/ws/**",            // WebSocket APIs if used
//                    "/v3/api-docs/**",   // OpenAPI docs
//                    "/swagger-ui/**",    // Swagger UI resources
//                    "/swagger-ui.html"
//                ).permitAll()           // Allow public access to the above routes
//                .anyRequest().authenticated()  // Require authentication for all other requests
//            )
//            .sessionManagement()
//                .sessionCreationPolicy(SessionCreationPolicy.STATELESS) // Stateless session policy
//            .and()
//            .authenticationProvider(authProvider())  // Register custom authentication provider
...
//    }
	...
	@Bean
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf().disable().cors().and().authorizeHttpRequests(auth -> auth.requestMatchers("/auth/**", // Public auth
																											// APIs
				"/ws/**", // WebSocket APIs without security
				"/v3/api-docs/**", // OpenAPI docs
				"/swagger-ui/**", // Swagger UI resources
				"/swagger-ui.html").permitAll() // Allow public access to the above routes
				.anyRequest().authenticated() // Require authentication for all other requests
